...
export declare function toLowerCase<T extends string>(value: any, defaultValue: T): T;
export declare function toUpperCase<T extends string>(value: any, defaultValue: T): T;
